  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            name="email"
            type="email"
            defaultValue={schoolAdmin.email} // Use schoolAdmin's attribute for email
            className="peer block w-full rounded-md border border-gray-200 py-2 text-sm outline-2 placeholder:text-gray-500"
            required
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            name="password"
            type="password"
            defaultValue={schoolAdmin.password} // Use schoolAdmin's attribute for password
            className="peer block w-full rounded-md border border-gray-200 py-2 text-sm outline-2 placeholder:text-gray-500"
            required
          />
        </div>
        ...
        {/* School Name */}
        <div className="mb-4">
          <label htmlFor="schoolName" className="mb-2 block text-sm font-medium">
            School Name
          </label>
          <input
            id="schoolName"
      ...
      <div className="mt-6 flex justify-end gap-4">
        <Link
          href="/dashboard/school-admins" // Update link to return to school-admins dashboard
