...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <h1 className={`${lusitana.className} text-2xl font-bold mb-4`}>{loading ? 'Processing' : 'Create an account to get started.'}</h1>
      <div className="rounded-lg bg-gray-50 px-6 pb-4 pt-8 w-96 space-y-3">
        <div>
          <label className="block text-xs font-medium text-gray-900" htmlFor="username">
            Username
          </label>
